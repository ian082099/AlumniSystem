...
$sql = "SELECT students.id, students.lastname, students.firstname, students.mi, students.email_address,
 ...
 WHERE course.id = 3"; // Remove semicolon to allow further modifications
...
<head>
    ...
    <style>
        ...
        * {
        ...
        body {
            background: url('/AlumniSystem/Users/CITCS/ACT/background.png') no-repeat center center fixed;
    ...
    h2 {
    text-align: center; /* Centers the "Welcome, ACT STUDENTS!" heading */
    font-size: 28px;
    font-weight: bold;
    margin-bottom: 20px;
}
...
h1 {
    text-align: left; /* Aligns "List of ACT Students" to the left */
    font-size: 20px;
    margin-bottom: 10px;
}
...
<body onload="setTimeout(() => document.body.classList.add('loaded'), 100);">
    <div class="dashboard-container">
      <h2>Welcome, ACT STUDENTS!</h2>
        <h1>List of ACT Students</h1>
