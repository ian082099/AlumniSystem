...
$sql = "SELECT students.id, students.lastname, students.firstname, students.mi, students.email_address,
 ...
 WHERE course.id = 1"; // Remove semicolon to allow further modifications
$conditions = [];
...
background: url('/AlumniSystem/Users/CITCS/CS/background.png') no-repeat center center fixed;
...
<body onload="setTimeout(() => document.body.classList.add('loaded'), 100);">
    <div class="dashboard-container">
        <h2>Welcome, COMPUTER SCIENCE STUDENTS!</h2>
